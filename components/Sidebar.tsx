    ...
    <aside className="bg-[#161916] border-r border-[#282A27] w-64 h-screen fixed top-0 left-0 flex flex-col">
        ...
        <Link href="/" className="flex items-center">
          <div className="flex items-center">
            <Image 
              ...
              height={60}
            />
            <span className="text-[#FF4F59] font-bold text-xl ml-2">{settings.projectName}</span>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-[#282A27]">
        <button 
          ...
          className="flex items-center px-4 py-3 text-[#FFFAF4] hover:bg-[#282A27] transition-colors w-full"
        >
          <span className="mr-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
