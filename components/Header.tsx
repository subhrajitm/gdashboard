...
export default function Header() {
  ...
  return (
    <header className="bg-[#161916] dark:bg-midnight light:bg-morning border-b border-[#282A27] py-4 px-6 flex justify-between items-center h-[120px]">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search..."
            className="bg-[#1d1f1d] dark:bg-first-light-1 light:bg-sunrise-cream px-4 py-2 rounded-lg border border-[#282A27] focus:outline-none focus:border-coral w-64 placeholder:text-gray-500 dark:text-sunrise-white light:text-midnight"
          />
        ...
        <button 
          onClick={toggleTheme}
          className="p-2 rounded-lg dark:bg-first-light-1 light:bg-sunrise-cream dark:text-sunrise-white light:text-midnight hover:bg-first-light-2 transition-colors"
